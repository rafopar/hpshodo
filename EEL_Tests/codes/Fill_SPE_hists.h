...
// Tue Apr  2 00:12:21 2019 by ROOT version 6.16/00
// from TChain Fill_SPE_hists/
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Fill_SPE_hists(int, TTree *tree=0);
   virtual ~Fill_SPE_hists();
...
#ifdef Fill_SPE_hists_cxx
Fill_SPE_hists::Fill_SPE_hists(int arun, TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      f->GetObject("Fill_SPE_hists",tree);

#else // SINGLE_TREE

      // The following code should be used if you want this class to access a chain
      // of trees.
      TChain * chain = new TChain("Fill_SPE_hists","");
      //chain->Add("../Data/Hodo_tests_329.root/tr1");
...
Fill_SPE_hists::~Fill_SPE_hists()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t Fill_SPE_hists::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t Fill_SPE_hists::LoadTree(Long64_t entry)
{
...
void Fill_SPE_hists::Init(TTree *tree)
{
...
void Fill_SPE_hists::Show(Long64_t entry)
{
...
Int_t Fill_SPE_hists::Cut(Long64_t entry)
{
...
#endif // #ifdef Fill_SPE_hists_cxx
