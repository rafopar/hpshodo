...
//    ch_list_signal[171] = vector<int>{0, 1, 2, 3, 4, 5, 6, 7};
    ...
    ch_list_signal[291] = vector<int>{8, 9, 10, 11, 12, 13, 14, 15};
    ch_list_signal[291] = vector<int>{0, 1, 2, 3, 4, 5, 6, 7};

//    const int run_spe1 = 153;
//    const int run_spe2 = 154;
    const int run_spe1 = 291;
    const int run_spe2 = 291;
    
    map<int, string> PMT_Serie;
    PMT_Serie[153] = "SA3663";
    PMT_Serie[154] = "SA3663";
    PMT_Serie[198] = "SA3857";
    PMT_Serie[199] = "SA3857";
    PMT_Serie[291] = "SA2060";
    
    ch_list_sphe[run_spe1] = vector<int>{0, 1, 2, 3, 4, 5, 6, 7};
    ch_list_sphe[run_spe2] = vector<int>{8, 9, 10, 11, 12, 13, 14, 15};
    ...
    ofstream out_SPE(Form("PMT_SPE_%s.dat", PMT_Serie[run_spe1].c_str()));
    ...
    c1->Print(Form("Figs/Q1_variations_%s.eps", PMT_Serie[run_spe1].c_str()));
    c1->Print(Form("Figs/Q1_variations_%s.pdf", PMT_Serie[run_spe1].c_str()));
    c1->Print(Form("Figs/Q1_variations_%s.png", PMT_Serie[run_spe1].c_str()));
